...
class mapi_lib:
	...
	def createUser(self, login_name, login_pass, user_type, first_name, last_name, email, user_role, mfa_status=None):
		user_data = self.create_user_data("", login_name, login_pass, user_type, first_name, last_name, email, user_role, mfa_status)
	...
	def updateUser(self, user_id, first_name, last_name, user_role, email=None, login_name=None, login_pass=None, user_type=None, mfa_status=None):
		user_data = self.create_user_data(user_id, login_name, login_pass, user_type, first_name, last_name, email, user_role, mfa_status)
...
if __name__ == '__main__':
	...
	failActionDelay="15"
	device_id_list=[]
	image_id_list=["Agent-BVT.AgentBVT_org.vApp_agentBVT.AgentBVT-Vcloud-Centos63-x86"]
