...
def outPutXML(tfile, defineID, targetID):
    global notExecuted
    ...
    # if the result file exists, then parse this file
        ...
        print eachLine
        print "Result: " + result
        writeXML(defineID, targetID, result)
...
def writeXML(defineID, targetID, result):
    global notExecuted
    ...
    SCTMResultFolder = 'c:/tmp/'
    print SCTMResultFolder
...
if len(sys.argv) < 3:
    ...
    tfile = sys.argv[1]
    defineID = sys.argv[2]
    outPutXML(tfile, defineID, "")
elif len(sys.argv) == 4:
    # The first parameter is the name of this script
    tfile = sys.argv[1]
    defineID = sys.argv[2]
    targetID = sys.argv[3]
    outPutXML(tfile, defineID, targetID)
else:
